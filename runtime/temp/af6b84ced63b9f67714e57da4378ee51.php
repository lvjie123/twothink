<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/property\edit.html";i:1552631602;s:94:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <textarea name="content" class="textarea input-large"  id="" cols="54" rows="10" ><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
