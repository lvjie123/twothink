<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/inform\index.html";i:1552707134;s:94:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
    ...
    <div class="search-form fr cf">
        <div class="sleft">
            <input type="text" name="title" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入标题">
    ...
    <table class="">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="confirm ajax-get" href="<?php echo url('del?id='.$vo['id']); ?>">删除</a>
            </td>
        </tr>
