<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/user/view/default/user\forme.html";i:1552966710;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('Index/login'); ?>" class="navbar-link">我的</a></p>
            </div>
        </div>
    </nav>
    <!--导航结束-->
