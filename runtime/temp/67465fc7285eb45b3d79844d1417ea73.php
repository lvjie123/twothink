<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/inform\index.html";i:1552992373;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <div id="test">
            ...
            <div class="row noticeList">
                <a href="<?php echo url('Inform/list?id='.$vo['id']); ?>">
                    <div class="col-xs-2">
        ...
        ajax.onreadystatechange=function () {
            if(ajax.readyState=='4'&&ajax.status=='200'){
                ...
                if(data['on_page']>=$count){
                    ...
                    $('#a').html('<a  onclick="test(<?php echo $count; ?>,'+data['on_page']+',<?php echo $info; ?>)">点击查看更多</a>')
                }
            }
        }
    }
