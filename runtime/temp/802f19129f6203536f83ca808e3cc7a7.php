<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/index\service.html";i:1552967079;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <ul class="list-group fuwuList">
                ...
                <li class="list-group-item"><a href="<?php echo url('Inform/index?info=-1&on_page=5'); ?>" class="text-warning"><span class="iconfont">&#xe601;</span>生活贴士</a></li>
                <li class="list-group-item"><a href="/user/user/forme" class="text-primary"><span class="iconfont">&#xe600;</span>关于我们</a></li>
            </ul>
        </div>
    </div>
</div>
