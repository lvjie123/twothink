<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"D:\phpstudy\PHPTutorial\WWW\0920PHP\twothink\public/../application/home/view/default/index\index.html";i:1553342297;}*/ ?>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="/user/user/my" class="navbar-link">我的</a></p>
            </div>
        </div>
    </nav>
    <!--导航结束-->
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/homecss/image/index.png" width="100%" />
        </div>
        <?php
float?>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="<?php echo url('Inform/index?info=43&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Inform/index?info=45&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Inform/index?info=44&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Rent/index'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Inform/index?info=46&on_page=1'); ?>">
