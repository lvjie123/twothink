<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/property\add.html";i:1552624522;s:94:"E:\PhpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea name="content" id="" cols="30" rows="10" class="textarea input-large"><?php echo (isset($content['title']) && ($content['title'] !== '')?$content['title']:''); ?></textarea>
            </div>
        </div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo url('Property/index'); ?>');
    </script>
