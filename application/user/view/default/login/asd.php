        ...
        <div class="span12">
            <form class="login-form" action="" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" id="inputPassword1"  class="span3" placeholder="请输入密码"  errormsg="密码为6-20位" nullmsg="请填写密码" datatype="*6-20" name="password">
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block">登 陆</button>
                        <br>
