...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '2V?NGzS1nsh,49cEIBlW7b{F}x:MXvpAJ]g;-#[k', //默认数据加密KEY
	'data_cache_key'=> '2V?NGzS1nsh,49cEIBlW7b{F}x:MXvpAJ]g;-#[k',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'2V?NGzS1nsh,49cEIBlW7b{F}x:MXvpAJ]g;-#[k', //加密KEY
